...
class EventSeeder extends Seeder
{
    ...
    public function insertEvents(int $count): void
    {
        ...
        // "City, Country" labels aligned to CITY_ANCHORS order, so each row's
        // denormalized `city` column is stamped in O(1) by anchor index.
        $cityLabels = CityDirectory::anchorLabels();
        ...
        while ($remaining > 0) {
            ...
            for ($i = 0; $i < $batchSize; $i++) {
                ...
                $anchorIdx = mt_rand(0, $anchorCount - 1);
                $anchor = self::CITY_ANCHORS[$anchorIdx];
